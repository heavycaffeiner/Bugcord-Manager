...
private val logs: SnapshotStateList<LogEntry> = mutableStateListOf(
    ...
    LogEntry(
        ...
        stacktracePreview = persistentListOf(
            ...
            "\tat com.bugcord.manager.patcher.steps.prepare.FetchInfoStep.execute(FetchInfoStep.kt:31)",
            "\tat com.bugcord.manager.patcher.steps.prepare.FetchInfoStep\$execute\\$1.invokeSuspend(Unknown Source:15)",
        ),
    ),
    LogEntry(
        id = UUID.randomUUID().toString(),
