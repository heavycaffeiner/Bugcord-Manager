...
import com.bugcord.manager.ui.screens.home.*
...
private class HomeScreenParametersProvider : PreviewParameterProvider<InstallsState.Fetched> {
    ...
    private val bugcordIconBytes = Base64.decode(
    ...
    private val bugcordIcon = BitmapFactory
        .decodeByteArray(bugcordIconBytes, 0, bugcordIconBytes.size)
        .asImageBitmap()
        .let(::BitmapPainter)
