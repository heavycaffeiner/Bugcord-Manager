package com.bugcord.manager.ui.screens.iconopts
...
import com.bugcord.manager.ui.components.*
import com.bugcord.manager.ui.screens.iconopts.components.*
...
import com.bugcord.manager.ui.util.ColorSaver
import com.bugcord.manager.ui.util.throttledState
...
fun IconOptionsScreenContent(
    ...
    Scaffold(
        ...
        Column(
            ...
            RadioSelectorItem(
                name = stringResource(R.string.bugcord),
                description = stringResource(R.string.iconopts_variant_desc_bugcord),
                selected = mode == IconOptionsMode.Bugcord,
                onClick = remember { { setMode(IconOptionsMode.Bugcord) } },
            )
            RadioSelectorItem(
        ...
        Row(
            ...
            val drawable = if (mode == IconOptionsMode.CustomImage) {
                ...
                val color = when (mode) {
                    ...
                    IconOptionsMode.Bugcord -> PatchOptions.IconReplacement.BugcordColor
