package com.bugcord.manager.ui.widgets.updater
...
class UpdaterViewModel(
     ...
     *
     * It obtains all the releases that have an asset named `bugcord-manager-[tag].apk`,
    ...
    private suspend fun fetchInfo() {
        ...
        val (version, release, apkUrl) = releases
            .mapNotNull { release ->
                ...
                val asset = release.assets.find { it.name == "bugcord-manager-${release.tagName}.apk" }
                    ?: return@mapNotNull null
