...
import com.bugcord.manager.manager.InstallLogManager
...
class LogScreenModel(
    ...
    fun saveLog() = screenModelScope.launchIO {
        ...
        application.saveFile("Bugcord Install $formattedDate.log", content)
    }
    ...
    fun shareLog() {
        ...
        val formattedDate = data.getFormattedInstallDate()
        val formattedName = "Bugcord Install $formattedDate.log"
        val content = data.getLogFileContents()
