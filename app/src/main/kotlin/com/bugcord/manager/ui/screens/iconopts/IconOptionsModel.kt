...
class IconOptionsModel(
    ...
    // ---------- Replacement color ---------- //
    var selectedColor by mutableStateOf(HsvColor(IconReplacement.BugcordColor))
        private set
    ...
    init {
        when (prefilledOptions) {
            is IconReplacement.CustomColor if prefilledOptions.color == IconReplacement.BugcordColor -> {
                changeMode(IconOptionsMode.Bugcord)
                initSelectedColor(IconReplacement.BugcordColor)
            }
    ...
    fun generateConfig(): IconReplacement? {
        return when (mode) {
            ...
            IconOptionsMode.Bugcord -> IconReplacement.CustomColor(IconReplacement.BugcordColor)
