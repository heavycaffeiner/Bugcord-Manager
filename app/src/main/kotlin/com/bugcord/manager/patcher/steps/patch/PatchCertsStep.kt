...
import com.bugcord.manager.patcher.util.ArscUtil
...
import com.bugcord.manager.patcher.util.AxmlUtil.getMainAxmlChunk
import com.bugcord.manager.util.find
...
class PatchCertsStep : Step(), KoinComponent {
    ...
    // to inject into Bugcord, except with the resource ids pointing to certificate files changed
