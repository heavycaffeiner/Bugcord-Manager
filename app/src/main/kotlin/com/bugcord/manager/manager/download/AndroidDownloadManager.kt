package com.bugcord.manager.manager.download
...
import com.bugcord.manager.manager.download.IDownloadManager.ProgressListener
import com.bugcord.manager.manager.download.IDownloadManager.Result
...
class AndroidDownloadManager(application: Application) : IDownloadManager {
    ...
    override suspend fun download(url: String, out: File, onProgressUpdate: ProgressListener?): Result {
        ...
        val downloadId = DownloadManager.Request(url.toUri())
            .setTitle("Bugcord Manager")
            .setDescription("Downloading ${out.name}...")
            .setDestinationUri(Uri.fromFile(out))
            .setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE)
            .addRequestHeader("User-Agent", "Bugcord Manager/${BuildConfig.VERSION_NAME}")
