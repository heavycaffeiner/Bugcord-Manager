...
import com.bugcord.manager.MainActivity.Companion.EXTRA_COMPONENT_TYPE
import com.bugcord.manager.MainActivity.Companion.EXTRA_FILE_PATH
import com.bugcord.manager.MainActivity.Companion.EXTRA_PACKAGE_NAME
import com.bugcord.manager.manager.*
import com.bugcord.manager.patcher.InstallMetadata
import com.bugcord.manager.ui.screens.home.HomeScreen
import com.bugcord.manager.ui.screens.patching.PatchingScreen
...
import com.bugcord.manager.ui.screens.permissions.PermissionsScreen
import com.bugcord.manager.ui.screens.plugins.PluginsScreen
import com.bugcord.manager.ui.theme.ManagerTheme
import com.bugcord.manager.ui.widgets.updater.UpdaterDialog
...
class MainActivity : ComponentActivity() {
    ...
    companion object {
        /**
         * Intent action to trigger an immediate reinstallation of a specific Bugcord installation.
         * Required extra data:
         * - [EXTRA_PACKAGE_NAME] The target installation package name.
         */
        const val INTENT_REINSTALL = "com.bugcord.manager.REINSTALL"

        /**
         * Opens the plugins page for a specific Bugcord installation.
         * Required extra data:
         * - [EXTRA_PACKAGE_NAME] The target installation package name.
         */
        const val INTENT_OPEN_PLUGINS = "com.bugcord.manager.OPEN_PLUGINS"
         ...
         */
        const val INTENT_IMPORT_COMPONENT = "com.bugcord.manager.IMPORT_COMPONENT"

        /**
         * Specifies the target package name for an action.
         */
        const val EXTRA_PACKAGE_NAME = "bugcord.packageName"

        /**
         * Specifies the target file path for an action.
         */
        const val EXTRA_FILE_PATH = "bugcord.file"
         ...
         * - `patches`
         */
        const val EXTRA_COMPONENT_TYPE = "bugcord.componentType"
    }
}
